...
public struct LoginRequest : IFlatbufferObject
{
  ...
  public static Offset<Rose.Network.Packets.LoginRequest> CreateLoginRequest(FlatBufferBuilder builder,
  ...
  public static Offset<Rose.Network.Packets.LoginRequest> EndLoginRequest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Rose.Network.Packets.LoginRequest>(o);
  }
  public static void FinishLoginRequestBuffer(FlatBufferBuilder builder, Offset<Rose.Network.Packets.LoginRequest> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedLoginRequestBuffer(FlatBufferBuilder builder, Offset<Rose.Network.Packets.LoginRequest> offset) { builder.FinishSizePrefixed(offset.Value); }
};
